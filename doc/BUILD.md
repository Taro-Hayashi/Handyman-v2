...
パッドの間が狭いのでくっつかないように気をつけます（修正予定）。無線化しない場合は短絡されていても問題ありません。
![](./img/IMG_8022.jpg)
...
マスキングテープ等で軸や留め具を大きくすると改善することがあります。また、3Dプリンター製のパーツははんだごてを当てて溶かすことで溶接することができます。接着剤で接着することも可能です。

- はんだ付けを失敗した。部品が壊れた/無くなった。

基板や部品は単品で販売が可能ですのでご連絡ください。在庫を切らしている場合は2週間ほど頂くことがあります。
